...
export default function AboutUs() {
  return (
    <div className="relative overflow-y-scroll h-full bg-black">
      ...
      <div className="absolute top-0 left-0 w-full h-auto flex items-center justify-center p-4">
        <div className="bg-white/90 p-6 rounded-lg shadow-lg max-w-5xl w-full overflow-y-auto max-h-[80vh]">
